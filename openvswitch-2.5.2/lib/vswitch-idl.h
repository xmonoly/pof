...
#define ovsrec_bridge_col_work_mode (ovsrec_bridge_columns[OVSREC_BRIDGE_COL_WORK_MODE])
...
void ovsrec_bridge_verify_work_mode(const struct ovsrec_bridge *);
...
const struct ovsdb_datum *ovsrec_bridge_get_work_mode(const struct ovsrec_bridge *, enum ovsdb_atomic_type key_type);
...
void ovsrec_bridge_set_work_mode(const struct ovsrec_bridge *, const char *work_mode);
